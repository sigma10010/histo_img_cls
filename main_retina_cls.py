...
from datasets import RetinaPIL
...
# =========================BreakHis============================================================
ptrain = '/mnt/DATA_OTHER/retina/train/'
ptest = '/mnt/DATA_OTHER/retina/train/'
train_dataset = RetinaPIL(ptrain, transform=transforms.Compose([
                                transforms.ToTensor()
                                 
                             ]))
test_dataset = RetinaPIL(ptest, data_aug = False, transform=transforms.Compose([
                                transforms.ToTensor()
...
embedding_net = BreakHisEmbeddingNet(n_classes)
model = TripletClassificationNet(embedding_net, n_classes)
model_name = 'pnn1_triplet_c_retina_daug_2l1**15beta'
